...
# opp.string.substring "${stringZ}" 0      # abcABC123ABCabc
# opp.string.substring "${stringZ}" 1      # bcABC123ABCabc
# opp.string.substring "${stringZ}" 7      # 23ABCabc
# opp.string.substring "${stringZ}" 7 3    # 23AB
#
# Arguments:
